...
for i = 1:length(dirs);
    ...
    rhos{i} = correlationPos(strcat(dir, 'correlation_pos/'), cond, 0);
end
...
for i = 1:7 %offsets
    for j = 1:2 %hot vs cold
        ...
        for per = 1:3 %period
            ...
            ylabel('Heading vs. PVA direction correlation')
        ...
        print(scatterfig, strcat( plotdir, 'scattercor_offset',num2str(i-4), '_', conds{j} ), '-dpdf');
