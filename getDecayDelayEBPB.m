function [decays, delays] = getDecayDelayEBPB(dir, cond, l, delay, green)
...
for per = 1:3
    ...
    data = getData(cond, pers{per}, 7, 0); %smooth fluorescence but not vel. Makes it somewhat less noisy
